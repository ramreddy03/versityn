    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active" style="margin-top:0px">
            ...
            <form  id="signup-form" class="form-signin" method="post">
                <h3 style="text-align:left!important;">Request for new account</h3>
                ...
                <div class="clear"></div>
                <input type="text" placeholder="Phone" class="form-control" name="contactno" id="contactno" />
                <div class="clear"></div> <br/>
                <input class="btn text-muted text-center btn-success" type="submit" style="float:right;" value="Request Account" name="submit" />  
             <br/>     
			 
             <br/> 
             <a title="Login" href="<?php echo site_url("login/index"); ?>" style="float:left">Login?</a><div class="clear"></div><br>
