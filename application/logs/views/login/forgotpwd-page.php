    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
            ...
            <form  id="login-form" class="form-signin" method="post">
                <h3 style="text-align:left!important;">Forgot Password</h3>
                <input type="text" placeholder="Username / Email" class="form-control" name="email" id="loginuname" />
                <div class="clear"></div> <br/>
                <input class="btn text-muted text-center btn-success" type="submit" style="float:right;" value="Send" name="submit" />  
             <br/> 
