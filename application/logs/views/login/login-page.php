    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
            ...
            <form  id="login-form" class="form-signin" method="post">
             ...
             <br/> 
             <a title="Forgot Password" href="<?php echo site_url("login/forgotpwd"); ?>" style="float:left">Forgot Password?</a><div class="clear"></div><br>
             <a title="Sign up" href="<?php echo site_url("login/signup"); ?>" style="float:left">Sign up?</a><div class="clear"></div><br>
            </form>
             <br/>
        </div>
