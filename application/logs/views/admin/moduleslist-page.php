                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              ...
                              <?php //echo anchor("admin/cpanel/index", '<img src="'.$this->baseurl.'assets/default/img/close.png" height="20" width="20" />', array('title'=>'Close', 'style' => 'float:right;')); ?>&nbsp;  &nbsp; 
                               <?php echo anchor("admin/cpanel/modulesform", '<i class="icon-plus-sign-alt" style="float:right; color: #FFFFFF!important; font-size: 18px; margin-right:5px;"></i>', array('title'=>'Add new module')); ?>&nbsp; &nbsp; 
                            </div>
                            <div class="panel-body">
                                ...
                                <table class="table table-bordered sortableTable responsive-table" id ="dashboard-table">
                                    <thead>
                                        <tr>
                                            <th width="25%">Module<i class="icon-sort"></i><i class="icon-sort-down"></i> <i class="icon-sort-up"></i></th>
                                            <th width="15%">uristring<i class="icon-sort"></i><i class="icon-sort-down"></i> <i class="icon-sort-up"></i></th>
                                    ...
                                    <tbody>
										...
										<?php
											if (count($module_masterlist)>0) {
												foreach ($module_masterlist as $onerec) {
												...
												*/
													...
													$viewdetailslink = anchor("admin/cpanel/modulesform/".$onerec['idmodule_master'], $onerec['module'], array('title'=>'View details'));
										?>
										 <tr>
                                            <td class=" <?php echo $tdclass; ?>"><u><?php echo $viewdetailslink; ?></u></td>
                                            <td class=" <?php echo $tdclass; ?>"><?php echo $onerec['uristring']; ?></td>
                            ...
                            <table width="99%">
								<tr>
									<td width="50%">
										 <p class="text-warning">Click on <b>Module</b> to edit/view details</p>
									</td>
