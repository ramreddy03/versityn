           ...
           <br/>
                 ...
                 <!--TABLE, PANEL, ACCORDION AND MODAL  -->
                        ...
                        <div class="panel panel-default">
                            ...
                            <?php echo anchor("admin/dashboard/uploadexcel", 'Upload', array('title'=>'Upload new scheduling', 'style' => 'color:#FFFFFF!important;float:right;')); ?>
                            </div>
...
/*.custom-dd option {
	display:inline-block;
									...
									<div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                               <input type="text" id="scheduledon" name="scheduledon" class="form-control">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">DPA</label>

                                            <div class="col-lg-4">
                                                <select name="sel_dpa[0][dpaname]" id="dpaname_0">
												   <?php
													if(count($users_res)>0) {
														foreach ($users_res as $oneuser) {
															$key = $oneuser['username']."__".$oneuser['id_user']."__".$oneuser['email'];
													?>
														<option value="<?php echo $key; ?>"><?php echo $oneuser['firstname']; ?></option>
													<?php
														}
													}
												   ?>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Nodes</label>
                                            ...
                                            <div class="col-lg-6" style="display: inline">
												<table width="100%">
													<tr>
														...
														<td valign="middle">
															<select  id="select2" multiple name="sel_dpa[nodes][]" class=" chzn-done custom-dd ">
															</select>
														</td>
													</tr>
												</table>
                                        ...
                                        <div class="form-actions no-margin-bottom" style="text-align:center;">
											<br/> &nbsp;
                                            <input type="submit" value="Save" class="btn btn-primary " name="submit" onclick="selallopts();"  /> &nbsp;
                                            <br/>
                                        </div>
