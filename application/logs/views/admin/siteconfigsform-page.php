<?php
	...
	$newuser_creation = (!empty($siteconfigs['newuser_creation']) && $siteconfigs['newuser_creation'] != "") ? $siteconfigs['newuser_creation'] : '';
								...
								?>
                                    ...
                                    <div class="clear" style="clear:both;"></div><br/>
                                     ...
                                     <div class="form-group col-lg-6">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <div class="<?php echo $emptyclass; ?>"></div>
                                            <label class="control-label <?php echo $labelclass; ?>">Report new user</label>

                                            <div class="<?php echo $textboxclass; ?>">
                                               <textarea rows="4" class="form-control" name="newuser_creation" id="newuser_creation" /><?php echo $newuser_creation; ?></textarea>
                                            </div>
                                        </div>
