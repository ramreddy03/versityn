 ...
 */
/**
$config['APIUsername'] = $config['Sandbox'] ? 'pawangntd-facilitator_api1.gmail.com' : 'PRODUCTION_USERNAME_GOGES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'YY6XAGE9SZZZWZA9' : 'PRODUCTION_PASSWORD_GOGES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AB8MfBBLjOvssGN2DCuPpKHT.zsy' : 'PRODUCTION_SIGNATURE_GOGES_HERE';
*/
$config['APIUsername'] = $config['Sandbox'] ? 'santasardar1-facilitator_api1.gmail.com' : 'PRODUCTION_USERNAME_GOGES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'XYVS54KDSPFM8ECY' : 'PRODUCTION_PASSWORD_GOGES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AwTFdjwSjo1wOwBcSSzruJpQ4F3p' : 'PRODUCTION_SIGNATURE_GOGES_HERE';
...
$config['PayFlowVendor'] = $config['Sandbox'] ? 'pawan' : '';
